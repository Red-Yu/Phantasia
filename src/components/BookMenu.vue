      ...
      <div class="bm-menu-overlay" :class="{ 'bm-visible': isMenuOpen }">
        ...
        <div class="bm-book-stack">
          ...
          <div class="bm-site-title">
            <h1 :class="{ 'bm-visible': isMenuOpen }">
              READING<br />IS MORE THAN<br />WORDS
            </h1>
            <p :class="{ 'bm-visible': isMenuOpen }">
              An Interactive<br />Journey Of<br />Exploration
            </p>
          ...
          <div class="bm-books">
            ...
            <router-link
              to="/MyCabin"
              class="bm-book bm-book-2"
              :class="{ 'bm-visible': isMenuOpen }"
              @click="closeMenu"
            >
